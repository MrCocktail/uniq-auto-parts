...
<head>
    ...
    <title>Connexion - Uniq Auto Parts</title>
...
<div class="w-full max-w-md bg-white rounded-2xl shadow-lg p-8">
    ...
    <p class="text-slate-500 mb-6">Accedez a votre espace de gestion.</p>
    ...
    <form method="post" action="${pageContext.request.contextPath}/auth/login" class="space-y-4">
        ...
        <button type="submit"
                class="w-full rounded-lg bg-slate-800 px-4 py-2 text-white hover:bg-slate-700 transition-colors">
            Se connecter
        </button>
    </form>
    ...
    <p class="mt-5 text-sm text-slate-600">
        ...
        <a class="font-semibold text-slate-900 hover:underline" href="${pageContext.request.contextPath}/auth/signup">Creer un compte</a>
    </p>
</div>
</body>
</html>
